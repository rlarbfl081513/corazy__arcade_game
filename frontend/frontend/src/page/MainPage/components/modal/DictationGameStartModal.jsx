...
import { getDictationAlgorithms } from '@/api/dictationApi';
...
function DictationGameStartModal({ isOpen, onClose, onConfirm, confirmText }) {
    ...
    if (isOpen) {
      const fetchData = async () => {
        ...
        try {
          ...
          const algoData = await getDictationAlgorithms();
...
export default DictationGameStartModal;
